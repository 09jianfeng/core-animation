//
//  TableViewControllerForTestInsturctMent.m
//  CoreAnimationTest
//
...
@interface TableViewControllerForTestInsturctMent()
@property (nonatomic, strong) NSArray *items;
@end

@implementation TableViewControllerForTestInsturctMent
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *filePath = [[NSBundle mainBundle] pathForResource:item[@"suolong"] ofType:@"jpg"];
    //set image and text
